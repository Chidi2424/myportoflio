...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceId = "service_hx4u9nb";
    const templateId = "template_91p6qe2";
    const publicKey = "MwRrDc63ojY_EB8zZ";
    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto px-4">
          ...
          out to me via email or through my social media channels.I'm always
          open to discussing new opportunities,collaborations,or just a friendly
          chat about tech.
        </p>
